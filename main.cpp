 ...
 * @param pFile2 File where we write information
 */
void Auteur(FILE* pFile,FILE* pFile2,FILE* pFile3){
 ...
 * @param pFile2 File where we write information
 */
void DirectionVersMotAbstractOuEquivalent(FILE* pFile, FILE* pFile2,FILE* pFile3){
    if(boolean==0){
        if(isTxt)
        {
 ...
 * @param pFile2 File where we write information
 */
void ChercheMotApresAbstractOuEquivalent(FILE* pFile,FILE* pFile2,FILE* pFile3){
    fgets(Ligne,255,pFile);fgets(CopieLigne,255,pFile3);
 ...
 * @param pFile2 File where we write information
 */
void EcritureAbstract(FILE* pFile,FILE* pFile2,FILE* pFile3){
    RecupereDonnerLigne=strtok(Ligne," \t\n");
 ...
 * @param pFile2 File where we write information
 */
void Abstract(FILE* pFile,FILE* pFile2,FILE* pFile3){
    DirectionVersMotAbstractOuEquivalent(pFile,pFile2,pFile3);
    ChercheMotApresAbstractOuEquivalent(pFile,pFile2,pFile3);
    EcritureAbstract(pFile,pFile2,pFile3);
    if(isTxt)
    {
        fputs("\n",pFile2);
    }
 ...
 * @param pFile2 File where we write information
 */
void AllerVersReference(FILE* pFile,FILE* pFile2,FILE* pFile3){
    boolean = 1;
    whitRef = true;
 ...
 * @param pFile2 File where we write information
 */
void EcritureBibliographie(FILE*pFile,FILE* pFile2,FILE* pFile3){
    std::string motAbstract=RecuperationPartieDonnerLigne;
    std::string motAvecMajuscule="\0";
    boolean=1;
    if (whitRef) {
 ...
 * @param pFile2 File where we write information
 */
void Bibliographie(FILE* pFile,FILE* pFile2,FILE* pFile3){
    if(isTxt)
        fputs("Biblio :",pFile2);
    
    if(isXml)
        fputs("\t<biblio>",pFile2);
    AllerVersReference(pFile,pFile2,pFile3);
    EcritureBibliographie(pFile,pFile2,pFile3);
    if(isTxt)
        fputs("\n",pFile2);
...
//boolean2 =0 lorsque c'est à gauche
void essai(FILE* pFile,FILE* pFile2,int x,int boolean2){
    if( boolean2 == 0){
    ...
    std::cout<<RecupereDonnerLigne<<std::endl;
}
...
int main(int argc,char** argv)
{
    ...
    if (argc > 1 ){
        ...
        for (auto it = pdf_vect.begin(); it != pdf_vect.end(); it++)
        {
            ...
            RecuperationPartieDonnerLigne=strtok(RecupereDonnerLigne,"=\"");
            RecuperationPartieDonnerLigne=strtok(NULL,"=\"");
            weigthPage=atol(RecuperationPartieDonnerLigne);
            RecupereDonnerLigne=strtok(CopieLigneQuOnEtudie," \t\n");
            RecupereDonnerLigne=strtok(NULL," \t\n");
            RecupereDonnerLigne=strtok(NULL," \t\n");
            RecuperationPartieDonnerLigne=strtok(RecupereDonnerLigne,">=\"");
            RecuperationPartieDonnerLigne=strtok(NULL,">=\"");
            heigthPage=atol(RecuperationPartieDonnerLigne);
            fgets(Ligne,255,pFile);fgets(CopieLigne,255,pFile3);
            RecupereDonnerLigne=strtok(Ligne," \t\n");
            ...
            while (strcmp(RecupereDonnerLigne,"</doc>") !=0 && strcmp(RecupereDonnerLigne,"</body>")!=0 && strcmp(RecupereDonnerLigne,"</html>")!=0){
                ...
                while(strcmp(RecupereDonnerLigne,"</page>") != 0 && strcmp(RecupereDonnerLigne,"</doc>")!=0 && strcmp(RecupereDonnerLigne,"</body>")!=0 && strcmp(RecupereDonnerLigne,"</html>")!=0){
                    ...
                    if(strcmp(RecupereDonnerLigne,"<line")==0 && Modifier==0){
                        ...
                        RecuperationPartieDonnerLigne=strtok(NULL,"=\"");
                        if(*it=="Torres.pdf"){
                        std::cout<<(weigthPage/2)<<std::endl;
                        std::cout<<atol(RecuperationPartieDonnerLigne)<<std::endl;
                        std::cout<<std::endl;
                        }
                        if(atol(RecuperationPartieDonnerLigne)<(weigthPage/2)){
                            RecupereDonnerLigne=strtok(CopieLigneQuOnEtudie," \t\n");
                            RecupereDonnerLigne=strtok(NULL," \t\n");
                            RecupereDonnerLigne=strtok(NULL," \t\n");
                            RecupereDonnerLigne=strtok(NULL," \t\n");
                            ...
                            RecuperationPartieDonnerLigne=strtok(RecupereDonnerLigne,">=\"");
                            RecuperationPartieDonnerLigne=strtok(NULL,">=\"");
                            if(atol(RecuperationPartieDonnerLigne)>(heigthPage-200)){
                                Modifier=1;
                            }
                            else if(atol(RecuperationPartieDonnerLigne)>(heigthPage-30)){
                                fgets(Ligne,255,pFile);fgets(CopieLigne,255,pFile3);
                                strcpy(CopieLigneQuOnEtudie,Ligne);
                                RecupereDonnerLigne=strtok(Ligne," \t\n");
                                while(strcmp(RecupereDonnerLigne,"</line>")!=0){
                                ...
                                RecupereDonnerLigne=strtok(Ligne," \t\n");
                                essai(pFile3,pFile2,weigthPage/2,0);
                                strcpy(Ligne,CopieLigneQuOnEtudie);
                                RecupereDonnerLigne=strtok(Ligne," \t\n");
                                essai(pFile,pFile2,weigthPage/2,1);
                            }
                        }
